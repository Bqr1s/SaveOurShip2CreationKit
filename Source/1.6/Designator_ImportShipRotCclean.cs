...
namespace SaveOurShip2
{
	...
	public class Dialog_LoadShipRotCclean : Dialog_RenameShip
	{
		...
		{
			Map map = GetOrGenerateMapUtility.GetOrGenerateMap(ShipInteriorMod2.FindWorldTile(false), new IntVec3(250, 1, 250), DefDatabase<WorldObjectDef>.GetNamed("ShipEnemy"));
